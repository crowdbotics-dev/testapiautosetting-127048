...
## Project Structure
    ...
    ├── testapiautosetting_127048  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127048`
...
2. Clone this repo and `cd testapiautosetting_127048`
